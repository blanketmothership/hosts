...
.NOTES
    ...
    Version : v4.12 (Phase-1 cmdlet hang fix + report defaults.
...
function Invoke-CmdletWithTimeout {
    ...
    # Cap requested timeout at remaining script budget so we never
    # blow past the wall-clock deadline waiting on a hung cmdlet.
