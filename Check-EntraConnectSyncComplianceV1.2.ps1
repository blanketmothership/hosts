...
.NOTES
    ...
    Version : v1.2 (Per-version notes removed from the embedded
                    End-of-Support table; report no longer renders a
                    per-row note line. No functional change.)
              v1.1 (Embedded End-of-Support table + rolling EOL
                    detection. Adds -EOLWarnDays / -SkipEOLCheck params,
                    new ROLLING END-OF-SUPPORT report section, and a
                    -VersionDataAsOf timestamp surfacing table freshness.)
              v1.0 (initial)
#>
...
$Script:VersionEOLTable = @(
    [PSCustomObject]@{ Version = '2.3.2.0';   EOLDate = (Get-Date '2025-04-30') }
    [PSCustomObject]@{ Version = '2.3.6.0';   EOLDate = (Get-Date '2025-04-30') }
    [PSCustomObject]@{ Version = '2.3.8.0';   EOLDate = (Get-Date '2025-04-30') }
    [PSCustomObject]@{ Version = '2.3.20.0';  EOLDate = (Get-Date '2025-04-30') }
    [PSCustomObject]@{ Version = '2.4.18.0';  EOLDate = (Get-Date '2025-10-09') }
    [PSCustomObject]@{ Version = '2.4.21.0';  EOLDate = (Get-Date '2025-11-15') }
    [PSCustomObject]@{ Version = '2.4.27.0';  EOLDate = (Get-Date '2026-01-15') }
    [PSCustomObject]@{ Version = '2.4.129.0'; EOLDate = (Get-Date '2026-03-27') }
    [PSCustomObject]@{ Version = '2.4.131.0'; EOLDate = (Get-Date '2026-05-26') }
    [PSCustomObject]@{ Version = '2.5.3.0';   EOLDate = (Get-Date '2026-07-31') }
    [PSCustomObject]@{ Version = '2.5.76.0';  EOLDate = (Get-Date '2026-09-01') }
    [PSCustomObject]@{ Version = '2.5.79.0';  EOLDate = (Get-Date '2026-10-23') }
    [PSCustomObject]@{ Version = '2.5.190.0'; EOLDate = (Get-Date '2027-02-02') }
    [PSCustomObject]@{ Version = '2.6.1.0';   EOLDate = (Get-Date '2027-03-10') }
    [PSCustomObject]@{ Version = '2.6.3.0';   EOLDate = $null                    }
)
...
function Get-EntraConnectSyncEOL {
    ...
    if ($null -eq $match.EOLDate) {
        ...
        $r.Note   = "No End-of-Support date set in the embedded table for the installed version"
        return $r
    }
